...
import com.beenleigh.dsl.web.LemmaWebSetup;
...
public class LemmaServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      LemmaWebSetup _lemmaWebSetup = new LemmaWebSetup(executorServiceProvider);
      _lemmaWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
